...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    self.params['W1'] = weight_scale*np.random.normal(0,weight_scale,size=(num_filters,C,filter_size,filter_size))
    self.params['b1'] = np.zeros((num_filters,))

    H1 = H/2
    W1 = W/2
    squash_size = H1 * W1 * num_filters
    
    self.params['W2'] = np.random.normal(0,weight_scale,size=(squash_size,hidden_dim))
  ...
  def loss(self, X, y=None):
    ...
    aff2_out,aff2_cache = affine_forward(ar_out,W3,b3)
